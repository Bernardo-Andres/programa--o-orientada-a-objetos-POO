        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                */
                ...
                Cao cao = new Cao(Integer.parseInt(id), nome, cor, Integer.parseInt(idade), sexo, raca, porte, peso, proprietario);
                caes.add(cao);
                proprietario.adicionarAnimal(cao);
                ProprietarioController.proprietarios.remove(proprietario);
                ProprietarioController.proprietarios.add(proprietario);
                view.mostrarMensagem("Cao cadastrado com sucesso!");
                view.mostrarCao(caes);
